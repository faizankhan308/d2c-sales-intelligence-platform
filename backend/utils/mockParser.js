// High-fidelity D2C brands data matching user requested examples
const PRESET_BRANDS = {
  "boat-lifestyle.com": {
    brandName: "boAt Lifestyle",
    website: "boat-lifestyle.com",
    logo: "https://logo.clearbit.com/boat-lifestyle.com",
    industry: "Electronics & Audio",
...
export function generateMockBrandAnalysis(domain) {
  ...
  return {
    ...
    priorityScore,
    confidenceScore,
    confidenceReason: "Analyzed site framework tags, detected cart buttons, and checked domain domain age indicators.",
